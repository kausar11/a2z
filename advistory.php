...
<div class="et_pb_text_inner">
	<h1><span style="color: #ffffff; ">GETTING YOUR<br />ADVISORY SERVICE</span></h1>
</div>
</div> <!-- .et_pb_text -->
</div> <!-- .et_pb_column -->
...
<?php
				$sql = "select * from service_images where id='4'";
				$result = $db->query($sql);
...
<div class="et_pb_section et_pb_section_2 et_section_regular">
	...
	<div class="et_pb_text_inner">
		<h1><strong><span style="color: #417fbb;"><span style="color: #162232;"> ADVISORY SERVICE </span></span></strong></h1>
	</div>
	</div> <!-- .et_pb_text -->
	...
	<div class="et_pb_text_inner">
	<?php
		$sql = "select * from text where id='9'";
		$result = $db->query($sql);
		$data = mysqli_fetch_array($result);
		echo $data[2];
	?>
