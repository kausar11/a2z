		...
		(function ( $ ) {
			...
			<div id="fix-2" class="et_pb_section et_pb_section_1 et_section_regular">
				...
				<div class="et_pb_blurb_content">
					<div class="et_pb_main_blurb_image"><span class="et_pb_image_wrap"><span class="et-pb-icon et-waypoint et_pb_animation_top et-pb-icon-circle et-pb-icon-circle-border" style="color: #e16d38; background-color: rgba(65,127,187,0); border-color: #ffffff;"><i class="fa fa-clock-o"></i></span></span></div>
					<div class="et_pb_blurb_container">
						<h4 class="et_pb_module_header">Opening Hours</h4>
						<div class="et_pb_blurb_description">
							<p><span style="color: #ffffff;">Mon-Fri: (AEDT) 5am &gt; 7pm</span><br />
<span style="color: #ffffff;">Sat-Sun: (AEDT) 6am &gt; 4pm</span></p>
				...
				<div class="et_pb_blurb_content">
					<div class="et_pb_main_blurb_image"><span class="et_pb_image_wrap"><span class="et-pb-icon et-waypoint et_pb_animation_top et-pb-icon-circle et-pb-icon-circle-border" style="color: #e16d38; background-color: rgba(65,127,187,0); border-color: #ffffff;"><i class="fa fa-envelope-o"></i></span></span></div>
					<div class="et_pb_blurb_container">
						<h4 class="et_pb_module_header">Email Us</h4>
						<div class="et_pb_blurb_description">
							<p><i class="fa fa-envelope-o" style="margin-left:12px;"></i> <span>info@smiexpress.net </span></p>
						</div><!-- .et_pb_blurb_description -->
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
				...
				<div class="et_pb_blurb_content">
					<div class="et_pb_main_blurb_image"><span class="et_pb_image_wrap"><span class="et-pb-icon et-waypoint et_pb_animation_top et-pb-icon-circle et-pb-icon-circle-border" style="color: #e16d38; background-color: rgba(65,127,187,0); border-color: #ffffff;"><i class="fa fa-phone"></i></span></span></div>
					<div class="et_pb_blurb_container">
						<h4 class="et_pb_module_header">Call Us Anytime</h4>
						<div class="et_pb_blurb_description">
							<p><span style="color: #ffffff;">+88 01715030481</span></p>
						</div><!-- .et_pb_blurb_description -->
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
			...
			<div class="et_pb_section et_pb_section_2 et_section_regular">
				...
				<div class="et_pb_text_inner">
					<p>A 2 Z Logistics specialises in providing solutions to logistical challenges.</p>
				</div>
			</div> <!-- .et_pb_text -->
...
<div class="et_pb_section et_pb_section_6 et_pb_with_background et_section_regular">
	...
	<div class="et_animated et_pb_row et_pb_row_7">
		<div class="et_pb_column et_pb_column_4_4  et_pb_column_12 et_pb_css_mix_blend_mode_passthrough et-last-child">
			...
			<div class="et_pb_text_inner">
			<h1><span class="our_service">Our Service</span><span style="color: #e16d38;">.</span></h1>
			</div>
