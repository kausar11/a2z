...
<div class="et_pb_text_inner">
	<h1><span style="color: #ffffff;">GETTING YOUR<br />AIR
...
<div class="et_pb_section et_pb_section_2 et_section_regular">
	...
	<div class="et_pb_text_inner">
		<h1><strong><span style="color: #417fbb;"><span style="color: #162232;">AIR FREIGHT  </span></span></strong></h1>
	</div>
	</div> <!-- .et_pb_text -->
	...
	<div class="et_pb_text_inner">
	<?php
		$sql = "select * from text where id='2'";
		$result = $db->query($sql);
		$data = mysqli_fetch_array($result);
		echo $data[2];
	?>
