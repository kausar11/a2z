...
<article id="post-47799" class="post-47799 page type-page status-publish hentry">
	...
	<div id="section-fix" class="et_pb_section et_animated et_pb_section_0 et_section_regular">
				...
				<div class="et_pb_text_inner">
					<h1><span style="color: #ffffff;">GETTING OUR<br />LEGEL DOCUMENT</span></h1>
				</div>
			</div> <!-- .et_pb_text -->
			</div> <!-- .et_pb_column -->
...
<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular">
	...
	<div class="document_bg">
		<div class="document_list">
			<?php
				$sql = "select * from text where id='11'";
				$result = $db->query($sql);
				$data = mysqli_fetch_array($result);
				echo $data[2];
			?>
	...
	<div class="document_bg_1">
	<div class="document">
		<div class="img">
			<img class="legel_img" src="legeldocuments/baffa.jpg" alt="" />
		
			<img class="legel_img img_2" src="legeldocuments/trad.jpg" alt="" />
		</div>
		<div class="pdf">
			<object  style="width:984px;height:750px;margin-bottom:10px;box-shadow: 1px 1px 6px 8px rgb(221, 221, 221);margin-top: 25px;
" data="legeldocuments/khanlogistic_legel_doc.PDF"></object>
		</div>	
