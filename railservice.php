...
<div class="et_pb_text_inner">
	<h1><span style="color: #ffffff;">GETTING YOUR<br />REAIL SERVICE THERE</span></h1>
</div>
</div> <!-- .et_pb_text -->
</div> <!-- .et_pb_column -->
...
<?php
				$sql = "select * from product_images where id='4'";
				$result = $db->query($sql);
...
<div class="et_pb_section et_pb_section_2 et_section_regular">
	...
	<div class="et_pb_text_inner">
		<h1><strong><span style="color: #417fbb;"><span style="color: #162232;">REAIL SERVICE  </span></span></strong></h1>
	</div>
	</div> <!-- .et_pb_text -->
